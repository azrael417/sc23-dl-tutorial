...
from networks import vit_dtensor
...
#    torch.autograd.set_detect_anomaly(True)
    ...
    if comm.get_size("data") > 1:
        ...
        model = DDP(model, device_ids=[local_rank], output_device=[local_rank],
                    bucket_cap_mb=args.bucket_cap_mb, device_mesh=device_mesh["dp"])
...
if __name__ == '__main__':
    ...
    parser.add_argument("--matmul_parallel_size", default=1, type=int, help="Number of row comms")
    ...
    model_parallel_size = args.matmul_parallel_size
    ...
    # init device mesh
    model_parallel_size = args.matmul_parallel_size
    data_parallel_size = comm.get_world_size() // model_parallel_size
    device_mesh = init_device_mesh("cuda", mesh_shape=(data_parallel_size, model_parallel_size),
    ...
    train(params, args, local_rank, world_rank, world_size, device_mesh)
